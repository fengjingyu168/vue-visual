...
export const loading = {
  start: ()=>{
    let htmlLevel1 ='<div id="loadingContainer" class="loadingContainer" style="width: 100%;height: 100%;position: fixed;background: #E0E0E0;bottom: 0;text-align: center;opacity: 0.5;z-index:9000">'
 ...
 * @param 你懂得
 */
function httpRequestEntrance (method, url, data, callback, isNeedloading = true) {
  if (isNeedloading) {
    loadingCount++
    loading.start()
  }
